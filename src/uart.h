...
// extern verwendete Variablen - in meiner Unwissenheit hier eingetragen
...
extern unsigned int uartx_getc(uint8_t uartnr);
extern void uartx_putc(uint8_t uartnr, unsigned char data);
extern void uartx_puts(uint8_t uartnr, const char *s );
extern void uartx_puts_p(uint8_t uartnr, const char *s );
#define uartx_puts_P(n, __s)       uartx_puts_p(n, PSTR(__s))
